...
-- cmsj - setfenv was removed in Lua 5.2
...
setfenv(debug.getinfo(1, "f")["func"], P)                                 --globals go in P, which is published as objc.debug
...
local function autoload(k)
	return submodules[k] and require("hs.ffi."..submodules[k]) and objc[k]
end
